...
(function(window) {
    ...
    const SNAKE = {
        ...
        _initGame: function() {
            // 加载最高分
            const savedHighScore = this._getHighScore();
            if (savedHighScore > 0) {
                this._setHighScore(savedHighScore);
        ...
        _setHighScore: function(value) {
            ...
            try {
                localStorage.setItem('snake_highscore', String(value || 0));
            } catch (e) {
                // 忽略 localStorage 错误
            }
        },
